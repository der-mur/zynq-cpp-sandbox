...
HD_PWD='F:/Documents/GitHub/zynq-cpp-sandbox/2023.2/zybo-z7-20/hw_proj1/hw_proj1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_proj1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_proj1_wrapper.tcl
