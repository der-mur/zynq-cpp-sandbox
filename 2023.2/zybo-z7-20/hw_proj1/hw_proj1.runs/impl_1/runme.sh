...
HD_PWD='F:/Documents/GitHub/zynq-cpp-sandbox/2023.2/zybo-z7-20/hw_proj1/hw_proj1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_proj1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_proj1_wrapper.tcl -notrace
