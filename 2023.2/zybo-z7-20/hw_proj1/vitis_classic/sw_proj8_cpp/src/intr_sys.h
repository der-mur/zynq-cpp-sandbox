...
int addTtc0ToInterruptSystem(TtcSingleTimer* p_TtcSingleTimer0_0); // called by system_config.cpp
int addUart1ToInterruptSystem(PsUart* p_PsUart1); // called by system_config.cpp
