...
int main()
{
...
#if MAIN_DEBUG
	printf("\n\r-----------------------------------------------------------\n\r");
	printf("----------- Zynq Fundamentals Software Project 5 ----------\n\r");
	printf("-----------------------------------------------------------\n\r");
	printf("Title: Zynq-7000 Interrupts.\r\n");
	printf("Architecture: Polled State Machine.\r\n");
	printf("Timing: SCU Timer (CPU0 Private Timer).\r\n\r\n");
	...
	for(;;) // Infinite loop
	{
		...
		switch (state) {
			case INIT:
				p_DriverPointers->p_ScuTimerCore0->start();
				task1_complete = 0U;
				task2_complete = 0U;
				state = TASK1;
				break;
